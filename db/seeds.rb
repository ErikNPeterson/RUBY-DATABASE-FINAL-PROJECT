...
# ######### Message #########
# message1 = Message.create!(event: event1, user: user1, content: "I can't wait! Anyone else going??");  
# message2 = Message.create!(event: event1, user: user2, content: "I'll DEFINITELY be there!"); 
# message3 = Message.create!(event: event1, user: user3, content: "This looks super funnnnnn!!"); 
# message4 = Message.create!(event: event1, user: user4, content: "See you guys there!");
# message5 = Message.create!(event: event1, user: user1, content: "WAHOOOOOOO!!");  
# message6 = Message.create!(event: event1, user: user3, content: "Yeeeeeeeeey!!"); 

# message7 = Message.create!(event: event2, user: user3, content: "Is this event good??");  
# message8 = Message.create!(event: event2, user: user1, content: "Last year's was amazing!"); 
# message9 = Message.create!(event: event2, user: user3, content: "I should go!"); 
# message10 = Message.create!(event: event2, user: user2, content: "Let me join!");
...
# r_categories = RestClient.get('https://www.eventbriteapi.com/v3/categories/?token=IGLKPVVT7DEH4O2GRXSG')
